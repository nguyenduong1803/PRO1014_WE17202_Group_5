...
import style from "./TableOption.module.css"
            ...
            <div className="content__cart-box">
                {
                    carts && carts.map((cart, index) => {
                        return (<>
                            <ProductCartTable name={cart.name} content="content" img="https://www.eatthis.com/wp-content/uploads/sites/4/2022/05/steak-n-shake-7x7-steakburger.jpg?quality=82&strip=1" price={cart.price} quantity={ cart.amount} />
                        </>)
                    })
                }
