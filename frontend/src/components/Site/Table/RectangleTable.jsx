...
function RectangleTable({ colors, name, status }) {
    ...
    return (
        <div className={styles.wrapRectangle} style={rootColor} >
            <div className={styles.pulseRectangle}></div>
            <div className={styles.rectangle}>
                <span></span>
            </div>
            <h4 className={styles.tableName}>{name}</h4>
            <Chair position="bottom" cordinate="20px" left={true} />
            <Chair position="bottom" cordinate="20px" right={true}/>
            <Chair position="left" cordinate="-8px" />
            <Chair position="right" cordinate="-8px" />
            <Chair position="top" cordinate="20px" left={true} />
            <Chair position="top" cordinate="20px" right={true} />
