...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2022 at 07:02 PM
...
(7, 2, 4, 3, 5, 2, 1, '2022-07-24 17:23:19', NULL, 1, NULL);
...
INSERT INTO `detail_invoice` (`id`, `id_user`, `id_invoice`, `id_table_book`, `id_product`, `amount`, `created_at`, `update_at`, `delete_at`, `is_delete`) VALUES
(58, 5, 'R5K7PEQMIL', 5, 4, 5, '2022-07-28 15:20:03', '2022-07-28 09:50:01', NULL, 1),
(59, 5, 'R5K7PEQMIL', 4, 5, 3, '2022-07-28 15:20:03', NULL, '2022-07-28 09:56:52', 2),
(60, 5, 'R5K7PEQMIL', NULL, 4, 4, '2022-07-28 15:20:03', NULL, NULL, 1);
...
INSERT INTO `directory` (`id`, `name`, `is_delete`, `create_at`, `update_at`, `delete_at`) VALUES
(1, 'Bán chạy', 1, '2022-07-26 01:06:51', NULL, NULL),
(2, 'Hot sale', 1, '2022-07-26 01:06:51', NULL, NULL),
(3, 'Sản phẩm đặc biệt Quận 7', 1, '2022-07-26 01:16:03', '2022-07-25 18:33:35', NULL);
...
CREATE TABLE `invoices` (
  ...
  `id_user` int(11) NOT NULL,
  `id_invoice` varchar(12) NOT NULL,
  `user_name_book` varchar(50) NOT NULL,
  `time_book` timestamp NULL DEFAULT current_timestamp(),
...
INSERT INTO `invoices` (`id`, `id_user`, `id_invoice`, `user_name_book`, `time_book`, `phone`, `note`, `status_cart_order`, `total_price`, `status_envoice`, `id_staff`, `create_at`, `update_at`, `delete_at`, `is_delete`) VALUES
(12, 5, 'R5K7PEQMIL', 'Huu Duong', NULL, '0934545677', 'update', 1, 2700000, 2, 2, '2022-07-28 15:20:03', '2022-07-28 09:10:16', NULL, 1);
...
('178eacfa6650088b4ea067a012a40c91a40bcd20d2e18c9ac4d7267e238f1baceb3587a5e863b83a', 2, 1, 'duonglt', '[]', 0, '2022-07-25 07:12:23', '2022-07-25 07:12:23', '2023-07-25 14:12:23'),
...
('68902c13c165a97d3d554455e129d252736e80d47fb4284912cdafc67163e3226c61b7cf6a9efa8e', 5, 1, 'duonglt', '[]', 0, '2022-07-25 17:38:25', '2022-07-25 17:38:25', '2023-07-26 00:38:25'),
...
('cda005ad71b423ac99962d0151cb16c4757df7e650673aca116e75377388265a7349a7bf43c6cd14', 5, 1, 'duonglt', '[]', 0, '2022-07-25 18:15:00', '2022-07-25 18:15:00', '2023-07-26 01:15:00'),
...
('d5a594099248b85b0701f8f384e942200ab24ccec65d9d089cd8164b3291a6daf80036ced2c89168', 5, 1, 'duonglt', '[]', 0, '2022-07-25 08:52:38', '2022-07-25 08:52:38', '2023-07-25 15:52:38'),
...
('fa1ab81d4f3a0703c76c8642a131f39323662a9c01961f6231fb744979dd41950ab875d69c08fc39', 2, 1, 'duonglt', '[]', 0, '2022-07-25 07:29:03', '2022-07-25 07:29:03', '2023-07-25 14:29:03');
...
INSERT INTO `table_book` (`id`, `id_table`, `name_user`, `phone`, `total_user`, `time_book`, `status_book`, `description`, `id_user`, `create_at`, `update_at`, `delete_at`, `is_delete`) VALUES
(1, 4, 'Le Duong', '0944565787', 5, '2022-07-20 16:41:30', 1, '', NULL, '2022-07-19 16:41:54', NULL, NULL, 1),
(3, 4, 'Le Duong Update', '0945656787', 7, '2022-07-20 15:10:54', 1, '', 5, '2022-07-20 15:12:50', '2022-07-20 10:40:07', NULL, 1),
(4, 4, 'Huu Duong', '0944565787', 6, '2022-07-21 16:41:30', 2, '', 5, '2022-07-20 17:43:28', NULL, NULL, 1),
(5, 4, 'Hao Nam', '0956767898', 10, '2022-07-25 11:41:30', 2, 'test create', 5, '2022-07-25 14:34:47', NULL, NULL, 1),
(6, 4, 'Hao Nam', '0956767898', 10, '2022-07-25 11:41:30', 2, 'test create', 5, '2022-07-25 16:12:14', NULL, NULL, 1),
(7, 4, 'Hao Nam', '0956767898', 10, '2022-07-25 11:41:30', 2, 'test create', 5, '2022-07-26 00:53:09', NULL, NULL, 1);
...
(1, 'duong test 2', '$2y$10$3A/7BjM8euQ4StBkE.7LeOdUQcPRbQGEL16b.5/mAOk57GBsZXlsW', 'hcm', '1998-12-22', '0934565787', 1, NULL, NULL, 2, '2022-07-11 18:27:59', '2022-08-04 09:59:46', 2, 'duongtest3@gmail.com', NULL, NULL),
...
ALTER TABLE `detail_invoice`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_INVOICE_ID_TABLE_BOOK` (`id_table_book`),
  ADD KEY `FK_INVOICE_ID_USER` (`id_user`),
  ADD KEY `FK_INVOICE_IS_DELETE` (`is_delete`),
  ADD KEY `FK_INVOICE_ID_PRODUCT` (`id_product`);
...
ALTER TABLE `directory`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_DIRECTORY` (`is_delete`);
...
ALTER TABLE `invoices`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_INVOICES_ID_STAFF` (`id_staff`),
  ADD KEY `FK_INVOICES_ID_USER` (`id_user`),
  ADD KEY `FK_INVOICES_IS_DELETE` (`is_delete`),
  ADD KEY `FK_INVOICES_STATUS_CART_ORDER` (`status_cart_order`),
  ADD KEY `FK_INVOICES_STATUS_ENVOICE` (`status_envoice`);
...
--
ALTER TABLE `detail_invoice`
  ADD CONSTRAINT `FK_INVOICE_ID_PRODUCT` FOREIGN KEY (`id_product`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `FK_INVOICE_ID_TABLE_BOOK` FOREIGN KEY (`id_table_book`) REFERENCES `table_book` (`id`),
  ADD CONSTRAINT `FK_INVOICE_ID_USER` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `FK_INVOICE_IS_DELETE` FOREIGN KEY (`is_delete`) REFERENCES `status_delete` (`id`);

--
-- Constraints for table `directory`
--
ALTER TABLE `directory`
  ADD CONSTRAINT `FK_DIRECTORY` FOREIGN KEY (`is_delete`) REFERENCES `status_delete` (`id`);
...
--
ALTER TABLE `invoices`
  ADD CONSTRAINT `FK_INVOICES_ID_STAFF` FOREIGN KEY (`id_staff`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `FK_INVOICES_ID_USER` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `FK_INVOICES_IS_DELETE` FOREIGN KEY (`is_delete`) REFERENCES `status_delete` (`id`),
  ADD CONSTRAINT `FK_INVOICES_STATUS_CART_ORDER` FOREIGN KEY (`status_cart_order`) REFERENCES `cart` (`status_cart_order`),
  ADD CONSTRAINT `FK_INVOICES_STATUS_ENVOICE` FOREIGN KEY (`status_envoice`) REFERENCES `status_envoice` (`id`);
